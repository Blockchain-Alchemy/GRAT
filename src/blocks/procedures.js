...
delete Blockly.Blocks['functions_defnoreturn'];
delete Blockly.Blocks['functions_defreturn'];

/* eslint-disable quotes */
Blockly.defineBlocksWithJsonArray([
  {
    "type": "functions_defnoreturn",
    ...
    "extensions": [
      "get_function_def_no_return",
      "function_context_menu",
      "function_rename",
      "function_vars",
    ],
    "mutator": "function_def_mutator",
  },
  {
    "type": "functions_defreturn",
...
Blockly.Extensions.registerMixin('get_function_def_no_return', getDefNoReturn);

/**
 * Defines what are essentially info-getters for the functions_def_return
 * block.
 * @type {{callType_: string, getProcedureDef: (function(): Array)}}
 */
const getDefReturn = {
   ...
   * @type {string}
   */
  callType_: 'functions_callreturn',
};
...
Blockly.Extensions.registerMutator('function_def_mutator',
...
Blockly.Extensions.register('function_rename', procedureRename);
...
Blockly.Extensions.register('function_vars', procedureVars);
