...
/**
 * Defines the what are essentially info-getters for the entrypoint_defnoreturn
 * block.
...
/**
 * Defines what are essentially info-getters for the entrypoint_def_return
 * block.
 * @type {{callType_: string, getProcedureDef: (function(): Array)}}
 */
const getDefReturn = {
   ...
   * @type {string}
   */
  callType_: 'entrypoint_callreturn',
};
