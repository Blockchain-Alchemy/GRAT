...
const App = () => {
  ...
  const getHeight = () => {
    ...
    console.log(height);
    const workspace = ReactDOM.findDOMNode(document.querySelector("rect.blocklyMainBackground"));
    workspace.style.height = `calc(100% - ${height}px)`;
    const trash = ReactDOM.findDOMNode(document.querySelector("g.blocklyTrash image"));
    const trash1 = ReactDOM.findDOMNode(document.querySelector("g.blocklyTrash image:last-child"));
    ...
    <div className="App">
      <header className="App-header">
          ...
          <div className="absolute float-right bottom-0 right-0 text-white">
            <button className="btn bg-blue-600 clicked text-xl font-semibold hover:bg-blue-700 p-2 rounded-l-full pl-5" onClick={getBlock} ref={smartRef}>
            <span className="material-symbols-outlined">extension</span>
              Blocks
            </button>
            <button className="btn bg-blue-400 text-xl font-semibold hover:bg-blue-700 p-2 rounded-r-full pr-5" onClick={getPython} ref={pythonRef}>
      ...
      <div ref={BlockRef}>
        ...
        <div className="absolute bg-blue-400 p-2 rounded-md font-bold bottom-0 z-50 left-3/4" ref={controlRef}>
      ...
      <div className="absolute bottom-0 right-0 w-1/4" id="Sidebar" ref={sideRef}>
