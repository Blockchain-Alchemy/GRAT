...
delete Blockly.Blocks['sp_type_record'];

/* eslint-disable quotes */
Blockly.defineBlocksWithJsonArray([
  {
    "type": "sp_trecord",
    "message0": "sp.TRecord %1 %2",
    "message1": "%1",
    "args0": [
      {
        "type": "field_input",
    ...
    "extensions": [
      "get_type_of_record",
      "sp_trecord_context_menu",
      "sp_trecord_rename",
      "sp_trecord_vars",
    ],
    "mutator": "sp_trecord_def_mutator",
  }
]);
/* eslint-enable quotes */

/**
 * Defines the what are essentially info-getters for the sp_type_record
 * block.
...
Blockly.Extensions.registerMixin('get_type_of_record', getDefNoReturn);
...
Blockly.Extensions.registerMixin(
    'sp_trecord_context_menu', procedureContextMenu);
...
Blockly.Extensions.registerMutator('sp_trecord_def_mutator',
...
Blockly.Extensions.register('sp_trecord_rename', procedureRename);
...
Blockly.Extensions.register('sp_trecord_vars', procedureVars);
