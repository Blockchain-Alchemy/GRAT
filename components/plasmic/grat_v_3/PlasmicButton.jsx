...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 7D7rbF4eiHT/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: E3jHtZg22Yn/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: if9K40E9qYJ/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__fzfUz)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__rr1Ir)}
                role={"img"}
              />
            ),
